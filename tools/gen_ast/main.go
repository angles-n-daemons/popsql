...
func formatVisit(grammar []treeType, grammarType string) string {
	...
	newline("\tdefault:")
	newline(fmt.Sprintf("\t\treturn *new(T), fmt.Errorf(\"unable to visit type %%T\", typed%s)", grammarType))
